      ...
      if (row.getTime) {
         return (
            <Calendar
               ...
               style={[{
                  height: this.props.autoCalendarHeight ? null : this.props.calendarHeight,
         ...
         return (
            <View
               style={[{ height: this.props.calendarHeight, width: this.props.calendarWidth }, this.style.placeholder]}>
